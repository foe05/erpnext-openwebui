...
- **THEN** liefert der Connector eine chronologische Übersicht aus Kommunikation/Aktivitäten und verknüpften Belegen (Angebote, Aufträge, Rechnungen, Projekte)
...
- **THEN** legt der Connector ein ToDo/Notification-Objekt an, das zum Fälligkeitszeitpunkt auslöst
